 ...
 * 
 * public class ExtentManager { public static final ExtentReports extentReports
 * = new ExtentReports();
 * 
 * public synchronized static ExtentReports createExtentReports() {
 * ExtentSparkReporter reporter = new
 * ExtentSparkReporter(GlobalConstants.RELATIVE_PROJECT_PATH +
 * "/extentV5/ExtentReport.html");
