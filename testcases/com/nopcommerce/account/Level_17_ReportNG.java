 ...
 * 
 * public class Level_17_ReportNG extends BaseTest { private WebDriver driver;
 * private HomePageObject homePage; private RegisterPageObject registerPage;
 * //private SearchPageObject searchPage; private String emailAddress =
 * getEmailRandom();
 * 
 * @Parameters("browser")
 * 
 ...
 * 
 * @Test public void User_01_Register_Validate() {
 * log.info("Register - Step 1: Verify Register link displayed");
 * verifyFalse(homePage.isRegisterLinkDisplayed());
 * 
 * log.info("Register - Step 2: Click to Register link"); registerPage =
 ...
 * 
 * @Test public void User_02_Register_Success() {
 ...
 * 
 * log.info("Register - Step 3: Verify Email textbox with email value is" +
